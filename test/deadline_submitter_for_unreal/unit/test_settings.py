...
if __name__ == '__main__':
    ...
    def test_farm_with_id_like_name(self, mock_logger, mock_config):
        ...
        mock_self.work_station_configuration = MagicMock()
        mock_self.work_station_configuration.profile = MagicMock()
        mock_self.work_station_configuration.profile.default_farm = "farm-named-like-id"
        ...
        # Verify that find_farm_by_name was called with the correct name
        mock_self.find_farm_by_name.assert_called_with("farm-named-like-id")
    ...
    def test_farm_lookup_by_id(self, mock_logger, mock_config):
        ...
        mock_self.work_station_configuration = MagicMock()
        mock_self.work_station_configuration.profile = MagicMock()
        mock_self.work_station_configuration.profile.default_farm = "farm-67890"
        
        # Set up the mock to return None when find_farm_by_name is called
        mock_self.find_farm_by_name.return_value = None
        ...
        mock_self.find_farm_by_name.assert_called_with("farm-67890")
